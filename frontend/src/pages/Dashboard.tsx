  ...
  const getPageTitle = () => {
    if (mode === "admin") {
      switch (currentView) {
        ...
        case "sections":
          return "Homepage Section Management";
        case "about-us":
          return "About Us Page Management";
        case "contact-us":
          return "Contact Us Page Management";
        case "achievements":
          return "Achievement Year Management";
        case "settings":
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Manage your {mode === "admin" ? "admin" : "coach"} profile and
          preferences
        </p>
      </div>
