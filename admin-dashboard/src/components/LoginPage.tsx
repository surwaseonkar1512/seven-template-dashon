...
import { Mail, Lock, Eye, EyeOff, LogIn, Send, AlertCircle, GraduationCap, Users, Award, Sparkles } from 'lucide-react';
...
export function LoginPage({ onLoginSuccess, onSwitchToSignup, onSwitchToForgotPassword }: LoginPageProps) {
  ...
  return (
    <div className="min-h-screen flex overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-indigo-400/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
        ...
        <div className="relative z-10 max-w-lg space-y-8 animate-in fade-in slide-in-from-left duration-700">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-blue-100 text-sm">White-Label Coaching Platform</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              Create stunning, professional coaching websites in minutes. No coding required.
            </p>
          </div>
          ...
          <div className="space-y-4 pt-4">
            {[
              { icon: Users, text: 'Unlimited Students & Teachers', value: '10,000+' },
          ...
          <div className="p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-100">IIT-JEE Academy, Delhi</p>
              </div>
            </div>
            <p className="text-blue-50 italic">
              "CoachPro transformed how we manage our institute. Student enrollment increased by 200% in just 3 months!"
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl shadow-blue-500/10 p-8 border border-white/20">
            <Tabs defaultValue="password" className="w-full">
              <TabsList className="grid w-full grid-cols-2 mb-6 bg-gray-100/50">
                ...
                <TabsTrigger value="otp" className="data-[state=active]:bg-white data-[state=active]:shadow-sm">
                  OTP Login
                </TabsTrigger>
              </TabsList>
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        className={`pl-11 h-12 bg-gray-50/50 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all ${
                          passwordErrors.email ? 'border-red-500 focus:border-red-500 focus:ring-red-500/20' : ''
                        }`}
                      />
                    </div>
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        className={`pl-11 pr-11 h-12 bg-gray-50/50 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all ${
                          passwordErrors.password ? 'border-red-500 focus:border-red-500 focus:ring-red-500/20' : ''
                        }`}
                      />
                      <button
                        type="button"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        className={`pl-11 h-12 bg-gray-50/50 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all ${
                          otpErrors.email ? 'border-red-500 focus:border-red-500 focus:ring-red-500/20' : ''
                        }`}
                      />
                    </div>
                    {otpErrors.email && (
