...
import { Mail, Lock, ArrowLeft, Send, CheckCircle2, Eye, EyeOff, AlertCircle, Shield, GraduationCap, KeyRound } from 'lucide-react';
...
export function ForgotPasswordPage({ onBackToLogin, onResetSuccess }: ForgotPasswordPageProps) {
  ...
  const validatePassword = (password: string): string => {
    return password.length < 8 ? 'Password must be at least 8 characters' : 
           !/(?=.*[a-z])(?=.*[A-Z])(?=.*\d)/.test(password) ? 'Password must contain uppercase, lowercase, and number' : '';
  };
  ...
  return (
    <div className="min-h-screen flex overflow-hidden bg-gradient-to-br from-slate-50 via-green-50 to-emerald-100">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-teal-400/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-xl text-green-100 leading-relaxed">
                Password recovery is quick and secure. We'll help you get back to managing your institute in no time.
              </p>
            </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-100">
                      Your security is our priority. We use industry-standard encryption and multi-factor authentication to protect your account.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 relative">
        <div className="w-full max-w-md space-y-6 animate-in fade-in slide-in-from-right duration-700">
          ...
          <div className="text-center space-y-4">
            <div className={`mx-auto w-20 h-20 rounded-full bg-gradient-to-br ${currentConfig.color} flex items-center justify-center shadow-lg animate-in zoom-in duration-500`}>
          ...
          <div className="flex items-center justify-center space-x-2">
            {(['email', 'otp', 'reset'] as Step[]).map((step, index) => {
              ...
              const currentIndex = ['email', 'otp', 'reset'].indexOf(currentStep);
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <Input
                      ...
                      onChange={handlePasswordChange}
                      className={`pl-11 pr-11 h-12 bg-gray-50/50 border-gray-200 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-all ${
                        passwordErrors.confirmPassword ? 'border-red-500 focus:border-red-500 focus:ring-red-500/20' : ''
                      }`}
                    />
                    <button
                      type="button"
